...
*** [[./01-getting-started.org][第一章：快速入门]]
- 安装和环境配置
- REPL 使用
- 第一个 Janet 程序
- 与其他 Lisp 的语法对比

*** [[./02-core-language.org][第二章：核心语言特性]]
- S-表达式和基本语法
- 词法作用域与闭包
- 求值模型
- 特殊形式详解
...
*** [[./03-data-structures.org][第三章：数据结构与类型系统]]
...
*** [[./04-functional-programming.org][第四章：函数式编程]]
- 函数定义与调用
- 高阶函数
- 闭包与词法作用域
- 函数组合与管道
...
*** [[./05-macros-metaprogramming.org][第五章：宏与元编程]]
- 宏系统基础
- 准引用（quasiquote）与反引用
- 编译期求值
- 代码生成模式
...
*** [[./06-modules-projects.org][第六章：模块与项目组织]]
- 模块系统
- import 与 require
- 包管理器 JPM
- 项目结构最佳实践
...
*** [[./07-concurrency.org][第七章：并发编程：纤程与事件循环]]
- 纤程（Fibers）基础
- 协程式并发模型
- 事件循环（Event Loop）
- 异步 I/O
...
*** [[./08-ffi-c-interop.org][第八章：FFI 与 C 互操作]]
- FFI 模块使用
- 调用 C 函数
- 结构体与指针操作
- 嵌入 Janet 到 C 程序
...
*** [[./10-system-programming.org][第十章：系统编程]]
- 文件系统操作
- 进程管理
- 信号处理
- 系统调用
...
*** [[./11-peg-parsing.org][第十一章：PEG 解析器]]
- PEG 语法入门
- 词法分析与语法分析
- 构建 DSL
- 实战：配置文件解析器
...
*** [[./13-testing-debugging.org][第十三章：测试与调试]]
- 单元测试
- 断言与错误处理
- REPL 驱动开发
- 调试技巧
...
*** [[./14-practical-projects.org][第十四章：实战项目]]
- 项目 1：命令行工具（CLI Tool）
- 项目 2：网络爬虫
- 项目 3：日志分析器
- 项目 4：简单的脚本语言解释器
...
*** [[./15-spork-library.org][第十五章：Spork 扩展标准库]]
- Spork 概览与安装
- 模块地图与功能分类
- 典型模块实战
- Spork 工具链与项目集成

*** [[./appendix-a-lisp-comparison.org][附录 A：与其他 Lisp 的详细对比]]
...
*** [[./appendix-b-api-reference.org][附录 B：Janet 核心 API 速查]]
- 核心函数速查表
- 常用宏速查表
- 标准库概览

*** [[./appendix-c-resources.org][附录 C：资源与社区]]
- 官方文档
- 优秀的第三方库
- 社区与贡献指南
- 推荐阅读
...
开始你的 Janet 之旅：[[./01-getting-started.org][第一章：快速入门]] →
